...
export default async function ProjectPage({ searchParams }) {
  ...
  if (params?.id) {
    return <><ViscontiProjectActionFrame projectId={params.id} /><ViscontiProjectCompanyCard projectId={params.id} /><ViscontiProjectSpvWorkflow projectId={params.id} /><ViscontiProjectDetailV2 /></>;
  }

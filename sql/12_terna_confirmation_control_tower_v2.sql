-- GRUPPO VISCONTI – TERNA CONFIRMATION CONTROL TOWER V2
-- Run after 10_terna_step_confirmation_v2.sql and 11_terna_confirmation_task_bridge_v2.sql.
-- Uses correlated aggregates so deadline/task counts are not multiplied by step joins.
...
COMMENT ON VIEW terna_connection_control_tower IS
  'Control tower for connection practices, including waiting/rejected Terna confirmations.';

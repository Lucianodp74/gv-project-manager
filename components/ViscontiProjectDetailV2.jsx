...
export default function ViscontiProjectDetailV2() {
  ...
  async function toggleArchive() {
    if (!project) return;
    const nextStatus = archived ? "connection" : "archived";
    ...
    try {
      ...
      setProject(prev => ({ ...prev, status: nextStatus, updated_at: new Date().toISOString() }));

    ...
    <section className="ct-shell">
      ...
      <div className="ct-card">
        <div className="ct-head">
          <div><div className="ct-kicker">Connection · Control Tower</div><div className="ct-title">Controllo operativo della connessione</div><div className="ct-sub">Milestone verificate, scadenze, attività e conferme esterne. La Regia Operativa indica invece l'azione da eseguire adesso.</div></div>
